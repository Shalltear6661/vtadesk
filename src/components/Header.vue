        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            <a href="/" class="logo logo-light">
              <span class="logo-sm">
                <img src="@/assets/vta_desk.png" alt="" height="22" />
              </span>
              <span class="logo-lg">
                <img src="@/assets/vta_desk.png" alt="" height="30" />
              </span>
            </a>
          </div>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown ms-sm-3 header-item topbar-user">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              <!-- item-->
              <h6 class="dropdown-header">Welcome {{ nama }}!</h6>
              ...
              <a v-show="sn != null" class="dropdown-item" href="/log-perangkat"
                ...
                ></i>
                <span class="align-middle">Device Log</span></a
              >
...
<script>
import vtadesk_logo from "@/assets/vta_desk_black.png";
